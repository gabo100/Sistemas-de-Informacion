                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <?php 
                                    $sqlA=mysql_query("Select * from tblarticulos ", $link);
                                    $arti = mysql_num_rows($sqlA);
                                ?>
                                <div class="col-xs-9 text-right">
                                    <div class="huge"><?php echo $arti; ?></div>
                                    <div>Articulos Registrados!</div>
                                </div>
                            </div>
                        </div>
                        <a href="#">
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <?php 
                                    $sqlU=mysql_query("Select * from tblusuarios ", $link);
                                    $user = mysql_num_rows($sqlU);
                                ?>
                                <div class="col-xs-9 text-right">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                            $sqlArticulos = mysql_query("select tblarticulos.codigo,tblarticulos.titulo, tblarea.descripcion, tblempresas.nombre, tblarticulos.estado
                                                                         from tblarticulos 
                                                                         inner join tblarea on tblarticulos.codarea = tblarea.codigo
                                                                         inner join tblempresas on tblarticulos.codempresa = tblempresas.codigo
                                                                         where tblarticulos.estado=1");
                                            while($rowA=mysql_fetch_array($sqlArticulos)){
                                        ?>
                                        <tr>
                                            <td><?php echo $rowA[1]; ?></td>
                                            <td><?php echo $rowA[2]; ?></td>
                                            <td><?php echo $rowA[3]; ?></td>
                                            <td><?php if($rowA[4]== 1){ echo "Activo";}else{echo "Inactivo";} ?></td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="postulacion.php?codart=<?php echo $rowA[0]; ?>" class="btn btn-default btn-block btn-success">Postularse</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php } ?>
